        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    cancel: function (_cancelledOpErr, callback) { return callback(); },
                ...
                sendingRegistrationRequest: {
                    ...
                    disconnect: function (callback) {
                        _this._fsm.handle('cancel', new azure_iot_common_1.errors.OperationCancelledError(''), function (_err) {
                    ...
                    register: function (_request, callback) { return callback(new azure_iot_common_1.errors.InvalidOperationError('another operation is in progress')); }
                },
                responseReceived: {
                ...
                polling: {
                    _onEnter: function (request, operationId, _pollingInterval, callback) {
