        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                detached: {
                    ...
                    accept: function (_message, callback) { return callback(new azure_iot_common_1.errors.DeviceMessageLockLostError()); },
                    reject: function (_message, callback) { return callback(new azure_iot_common_1.errors.DeviceMessageLockLostError()); },
                    abandon: function (_message, callback) { return callback(new azure_iot_common_1.errors.DeviceMessageLockLostError()); }
                },
                attaching: {
