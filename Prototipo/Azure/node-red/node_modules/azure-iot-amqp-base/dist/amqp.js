...
var Amqp = /** @class */ (function () {
    ...
    function Amqp(autoSettleMessages) {
        ...
        this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    _onEnter: function (disconnectCallback, err, _result) {
                    ...
                    attachSenderLink: function (_endpoint, _linkOptions, callback) { return callback(new azure_iot_common_1.errors.NotConnectedError()); },
                    attachReceiverLink: function (_endpoint, _linkOptions, callback) { return callback(new azure_iot_common_1.errors.NotConnectedError()); },
                    detachSenderLink: function (_endpoint, callback) { return _this._safeCallback(callback); },
                    detachReceiverLink: function (_endpoint, callback) { return _this._safeCallback(callback); },
                    initializeCBS: function (callback) { return callback(new azure_iot_common_1.errors.NotConnectedError()); },
                    putToken: function (_audience, _token, callback) { return callback(new azure_iot_common_1.errors.NotConnectedError()); },
                },
                connecting: {
                    ...
                    connection_close: function (_context) {
                    ...
                    disconnected: function (_context) {
                        var callback = _this._connectionCallback;
                        _this._connectionCallback = undefined;
                        manageConnectionHandlers('removeListener');
                ...
                connecting_session: {
                    ...
                    session_open: function (_context) {
                    ...
                    session_close: function (_context) {
                ...
                connected: {
                    ...
                    connect: function (_policyOverride, callback) { return callback(null, new azure_iot_common_1.results.Connected()); },
                    ...
                    attachReceiverLink: function (endpoint, linkOptions, done) {
                        ...
                        var permanentErrorHandler = function (_err) {
