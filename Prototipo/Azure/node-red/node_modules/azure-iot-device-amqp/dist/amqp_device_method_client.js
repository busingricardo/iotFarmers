        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                detached: {
                    ...
                    sendMethodResponse: function (_response, callback) { return callback(new azure_iot_common_1.errors.NotConnectedError('Method Links were detached - the service already considers this method failed')); },
                ...
                detaching: {
                    ...
                    '*': function (_callback) { return _this._fsm.deferUntilTransition('detached'); }
                }
            }
        });
