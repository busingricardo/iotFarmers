...
var AmqpTwinClient = /** @class */ (function (_super) {
            ...
            states: {
                            ...
                            if (err) {
                                ...
                                _this._client.attachSenderLink(_this._endpoint, _this._generateTwinLinkProperties(linkCorrelationId_1), function (senderLinkError, senderTransportObject) {
                                    if (senderLinkError) {
                                        ...
                                        _this._client.attachReceiverLink(_this._endpoint, _this._generateTwinLinkProperties(linkCorrelationId_1, true), function (receiverLinkError, receiverTransportObject) {
                ...
                detaching: {
                    _onEnter: function (err, detachCallback) {
                        ...
                        _this._client.detachSenderLink(_this._endpoint, function (detachSenderError, _result) {
                            ...
                            _this._client.detachReceiverLink(_this._endpoint, function (detachReceiverError, _result) {
    ...
    AmqpTwinClient.prototype._generateTwinLinkProperties = function (correlationId, autoaccept) {
