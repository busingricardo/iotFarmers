...
var Amqp = /** @class */ (function (_super) {
    ...
    function Amqp(authenticationProvider, baseClient) {
        ...
        _this._amqpLinkEmitter = new events_1.EventEmitter();
        _this._amqpLinkEmitter.setMaxListeners(Infinity);
            ...
            states: {
                disconnected: {
                    ...
                    sendEvent: function (amqpMessage, sendCallback) {
                        ...
                        _this._fsm.handle('connect', function (err, _result) {
                            if (err) {
                                sendCallback(err);
                            }
                            else {
                    ...
                    updateSharedAccessSignature: function (_token, callback) {
                ...
                authenticated: {
                    ...
                    sendEvent: function (amqpMessage, sendCallback) {
                        ...
                        if (_this._d2cLink) {
                            ...
                            _this._amqpLinkEmitter.once('senderLinkAttached', function (err) {
                                if (err) {
                            ...
                            if (_this._amqpLinkEmitter.listenerCount('senderLinkAttached') === 1) {
                                ...
                                _this._amqp.attachSenderLink(_this._d2cEndpoint, null, function (err, link) {
                                    ...
                                    _this._amqpLinkEmitter.emit('senderLinkAttached', err);
                                });
                            }
                        }
                    },
                    ...
                    enableC2D: function (callback) {
                        ...
                        if (_this._c2dLink) {
                            ...
                            _this._amqpLinkEmitter.once('receiverLinkAttached', function (err) {
                                if (err) {
                                    /*Codes_SRS_NODE_DEVICE_AMQP_16_033: [The `enableC2D` method shall call its `callback` with an `Error` if the transport fails to connect, authenticate or attach link.]*/
                            ...
                            if (_this._amqpLinkEmitter.listenerCount('receiverLinkAttached') === 1) {
                                ...
                                _this._amqp.attachReceiverLink(_this._c2dEndpoint, null, function (err, receiverLink) {
                                    ...
                                    _this._amqpLinkEmitter.emit('receiverLinkAttached', err);
                                });
                            }
                        }
                    },
                ...
                disconnecting: {
                    _onEnter: function (err, disconnectCallback) {
                        ...
                        async.series([
                            ...
                            function (callback) {
                                _this._amqpLinkEmitter.removeAllListeners('senderLinkAttached');
                                if (_this._d2cLink) {
                            ...
                            function (callback) {
                                _this._amqpLinkEmitter.removeAllListeners('receiverLinkAttached');
                                if (_this._c2dLink) {
                    ...
                    '*': function (_connectCallback) { return _this._fsm.deferUntilTransition(); }
                },
            }
        });
     ...
     *                                 completes execution.
     */
    Amqp.prototype.sendEventBatch = function (_messages, _done) {
     ...
     * @private
     */
    Amqp.prototype.sendOutputEventBatch = function (_outputName, _messages, _done) {
