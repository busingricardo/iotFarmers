<script type="text/javascript">
    RED.nodes.registerType('azureiotdevice',{
        ...
        defaults: {
            ...
            retryInterval: {value: 30, required:true, validate: RED.validators.number()},
            methods: {value: []},
            DPSpayload: {value:""},
...
<script type="text/x-red" data-template-name="azureiotdevice">
    ...
    <div id="node-input-device-tabs-content" style="min-height: 170px;">
        <div id="compact-device-tab-identity" style="display:none">
            ...
            <div class="form-row">
                <label for="node-input-retryInterval"><i class="icon-tag"></i> <span>Retry interval</span></label>
                <input type="integer" width=50 id="node-input-retryInterval" placeholder="%connection retry interval%">
            </div>
        </div>
