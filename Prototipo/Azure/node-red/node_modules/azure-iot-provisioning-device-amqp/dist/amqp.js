        ...
        _this._amqpStateMachine = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    respondToAuthenticationChallenge: function (_request, _sasToken, callback) { return callback(new azure_iot_common_1.errors.InvalidOperationError('Cannot respond to challenge while disconnected.')); },
                ...
                connected: {
                    ...
                    queryOperationStatus: function (_request, correlationId, operationId, callback) {
