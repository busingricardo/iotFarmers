...
var MqttTwinClient = /** @class */ (function (_super) {
    ...
    function MqttTwinClient(client) {
        ...
        _this._topicFsm = new machina.BehavioralFsm({
            ...
            states: {
                unsubscribed: {
                    _onEnter: function (_topicSubscription, err, callback) {
                        if (callback) {
                            callback(err);
                        }
                    },
                    ...
                    unsubscribe: function (_topicSubscription, callback) {
                ...
                subscribed: {
                    _onEnter: function (_topicSubscription, callback) {
                        callback();
                    },
                    subscribe: function (_topicSubscription, callback) {
                        callback();
                    },
                ...
                unsubscribing: {
                    _onEnter: function (topicSubscription, callback) {
                        var _this = this;
                        topicSubscription.mqttClient.unsubscribe(topicSubscription.topic, function (err, _result) {
                            if (err) {
