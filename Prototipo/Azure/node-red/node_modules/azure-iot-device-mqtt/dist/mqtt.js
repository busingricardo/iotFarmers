...
var Mqtt = /** @class */ (function (_super) {
        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    updateSharedAccessSignature: function (_sharedAccessSignature, callback) { callback(null, new azure_iot_common_1.results.SharedAccessSignatureUpdated(false)); },
                    sendMethodResponse: function (_response, callback) {
                ...
                disconnecting: {
                    _onEnter: function (disconnectCallback, _err) {
     ...
     *                                 completes execution.
     */
    Mqtt.prototype.sendEventBatch = function (_messages, _done) {
     ...
     */
    Mqtt.prototype.complete = function (_message, done) {
    ...
    Mqtt.prototype.setOptions = function (options, done) {
        ...
        if (!options.cert) {
            ...
            this._authenticationProvider.getDeviceCredentials(function (err, _credentials) {
                if (err) {
     ...
     * @private
     */
    Mqtt.prototype.sendOutputEventBatch = function (_outputName, _messages, _done) {
    ...
    Mqtt.prototype._getBaseTransportConfig = function (credentials) {
        ...
        var apiVersionString = azure_iot_common_1.endpoint.versionQueryString();
